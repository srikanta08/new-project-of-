...
function sortByName(order = 'asc') {
    ...
    allDataShowTable(sortedData);
}

function sortByMarks() {
    const sortedData = [...studentData].sort((a, b) => a.marks - b.marks);
    allDataShowTable(sortedData);
}

function sortByPassing() {
    const filteredData = studentData.filter(student => student.passing);
    allDataShowTable(filteredData);
}

function sortByClass() {
    const sortedData = [...studentData].sort((a, b) => a.class - b.class);
    allDataShowTable(sortedData);
}

function sortGenderByMale() {
    const maleData = studentData.filter(student => student.gender === "Male");
    allDataShowTable(maleData);
}

function sortGenderByFemale() {
    const femaleData = studentData.filter(student => student.gender === "Female");
    allDataShowTable(femaleData);
}
...
document.getElementById('sortGenderByMale').addEventListener('click',sortGenderByMale);
document.getElementById('sortGenderByFemale').addEventListener('click', sortGenderByFemale);



allDataShowTable(studentData);
